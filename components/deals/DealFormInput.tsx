                    ...
                    <FieldLabel htmlFor={field.name}>{inputLabel}{redRequired ? <span className="text-red-500">*</span> : ""}</FieldLabel>
                    {
                        !description ? (
                            ...
                            <Textarea
                                ...
                                autoComplete="off"
                                value={field.value}
                                className='flex w-full rounded-lg border resize-none border-border bg-card px-3.5 py-3 text-[15px] text-card-foreground shadow-sm transition-color placeholder:text-start min-h-25 focus-visible:outline-none focus-visible:border-primary focus-visible:ring-ring/10'
                            />
                        )
                    }
