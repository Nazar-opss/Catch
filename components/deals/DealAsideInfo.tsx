...
export default function DealAsideInfo({deal, userId}: { deal: DealAsideInfoProps; userId: string }) {
    ...
    return (
        <div className="sticky top-23 flex flex-col gap-4">
                        ...
                        <Button onClick={() => saveDealAction({ dealId: deal.id })} className="flex items-center bg-transparent text-[13px] text-slate-400 hover:text-slate-900 transition-colors gap-1.5 w-full justify-center hover:bg-white border cursor-pointer border-transparent hover:border-slate-200 hover:shadow-sm flex-1 rounded-lg py-2 px-3">
