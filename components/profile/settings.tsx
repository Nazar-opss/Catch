  ...
  return (
    <div className="flex flex-col gap-2 ">
      ...
      <Button
        ...
        className="w-full flex items-center cursor-pointer h-full! text-sm px-4 py-2.5 rounded-xl gap-3 border border-border bg-card font-semibold justify-start text-muted-foreground hover:text-foreground transition-all hover:bg-red-50 hover:border-red-200 group"
      >
