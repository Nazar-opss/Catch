...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "group/dropdown-menu-item relative flex cursor-pointer hover:bg-secondary text-foreground items-center gap-2.5 rounded-2xl px-3 py-2 text-sm font-medium data-inset:pl-9.5 ",
        className
      )}
      {...props}
    />
