...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "group/dropdown-menu-item relative flex cursor-pointer hover:bg-secondary text-secondary-foreground items-center gap-3 rounded-md px-3 py-2 text-sm font-medium data-inset:pl-9.5 ",
        className
      )}
      {...props}
    />
