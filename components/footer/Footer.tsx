...
export default function Footer() {
    return (
        <footer className="flex justify-center items-center bg-white border-t border-slate-200 py-10 mt-12">
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <Button variant={"outline"} size={"icon"} className="rounded-full cursor-pointer hover:bg-orange-100 hover:text-[#ea580c] h-8! w-8! border-0 bg-slate-100 p-1">
                            <FacebookIcon size={16} />
                        </Button>
                        <Button variant={"outline"} size={"icon"} className="rounded-full cursor-pointer hover:bg-orange-100 hover:text-[#ea580c] border-0 bg-slate-100 p-1 h-8! w-8!">
